...
// import img2 from "../components/assets/Main.jpeg"
  ...
  return (
    <div>
      ...
      >
        <div
          id="hero-part1"
          className="flex flex-col md:w-[60%] h-[50%] md:h-[100%] py-4 px-10"
        >
        ...
        <div id="hero-part2" className="md:w-[45%] px-4 md:px-0 ">
          ...
          <h3 className="text-md sm:text-lg md:text-xl pb-2 font-semibold mb-6">
            100$
          </h3>
          <h3 className="text-md sm:text-lg md:text-xl pb-2 font-semibold mb-1">
